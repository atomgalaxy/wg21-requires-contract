...
Due to the way this paper models the thinking around annotations, it may leave
fewer things undefined as [@P2388R2] does, despite the fact that that we aren't
allowing explicit closures yet.
